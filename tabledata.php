...
<?php
        ...
        $r1 = new Resources("DBMS"," The database is a collection of inter-related data which is used to retrieve, insert and delete the data efficiently. It is also used to organize the data in the form of a table, schema, views, and reports, etc.","https://meet.google.com/iig-vpgs-rrh");
        $r2 = new Resources("OS","An operating system (OS) is system software that manages computer hardware, software resources, and provides common services for computer programs.","https://meet.google.com/kil-jfp-imn");
